  ...
  return (
    <main className="min-h-screen p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="text-gray-600 font-mono">Loading field data...</div>
        ) : (
          <>
                ...
                <div key={c.id} className="bg-black/30 border border-gray-800 rounded-lg p-5 hover:border-gray-700 transition">
                  ...
                  <div className="grid grid-cols-4 gap-3 mb-3">
                    <div className="bg-[#050810] rounded p-2">
                      <div className="text-[10px] text-gray-600 font-mono">DEVICES</div>
                      <div className="font-mono text-sm">{c.weighted_signals.devices.toLocaleString()}</div>
                    </div>
                    <div className="bg-[#050810] rounded p-2">
                      <div className="text-[10px] text-gray-600 font-mono">NOISE</div>
                      <div className="font-mono text-sm">{c.weighted_signals.noise.toLocaleString()}</div>
                    </div>
                    <div className="bg-[#050810] rounded p-2">
                      <div className="text-[10px] text-gray-600 font-mono">URLS</div>
                      <div className="font-mono text-sm">{c.weighted_signals.urls}</div>
                    </div>
                    <div className="bg-[#050810] rounded p-2">
                      <div className="text-[10px] text-gray-600 font-mono">MEMORY</div>
                      <div className="font-mono text-sm">{c.weighted_signals.memory}</div>
                    </div>
                  </div>
